...
interface RecipeDataSource {
    ...
    suspend fun getRecipeByIds(recipesIds: List<String>, included: List<String> = listOf(), pageSize: Int = 20): List<Recipe>
    suspend fun getRecipes(filters: Map<String, String>, included: List<String>, pageSize: Int = 20, pageNumber: Int = 1): List<Recipe>
    suspend fun getRecipesFromStringFilter(filters: String, included: List<String>, pageSize: Int = 20, pageNumber: Int = 1): List<Recipe>
