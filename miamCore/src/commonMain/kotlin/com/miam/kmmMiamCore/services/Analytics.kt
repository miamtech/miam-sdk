...
import com.miam.kmmMiamCore.miam_core.model.jsonFormat
...
class Analytics: KoinComponent  {
    private val coroutineHandler = CoroutineExceptionHandler {
            _, exception -> println("Miam error in Analytics $exception ${exception.stackTraceToString()}")
    }
    ...
    fun init(supplierOrigin: String) {
        ...
        sendEvent("test", "/mypath", PlausibleProps(recipe_id = "test_recipe_id", pos_name = "test_pos_name"))
    }
    ...
    @Serializable
    data class PlausibleEvent(val name: String, val url: String, val domain: String, val props: PlausibleProps)
    ...
    companion object {
        ...
        const val EVENT_PAGEVIEW = "pageview"; // GA4 is page_view -> use this one on ga to autotrack some fields
