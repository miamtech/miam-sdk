#
#  Be sure to run `pod spec lint MiamIOSFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Vincent Kergonna"
  # spec.authors            = { "Vincent Kergonna" => "kergonna@k-interactive.fr" }
  # spec.social_media_url   = "https://twitter.com/Vincent Kergonna"
