    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ZStack(alignment: .topLeading) {
                    ...
                    VStack(alignment: .trailing){
                        HStack {
                            Image(systemName: "Like")
                                .frame(width: 40.0, height: 40.0, alignment: .center).background(MiamColor.sharedInstance.musterd).foregroundColor(MiamColor.sharedInstance.primaryText)
                        }
                    ...
                    VStack(alignment: .leading) {
                        Text("Idée repas")
                            ...
                            .padding(.leading, 110).padding(.trailing, Dimension.sharedInstance.lPadding+6)
                ...
                }.foregroundColor(MiamColor.sharedInstance.white).frame(minHeight: 50.0, maxHeight: 50.0)
                    .padding(.horizontal, Dimension.sharedInstance.lPadding)
                    .background(MiamColor.sharedInstance.primaryText).cornerRadius(25)
                    .font(.system(size: 16.0, weight: .bold, design: .default))
