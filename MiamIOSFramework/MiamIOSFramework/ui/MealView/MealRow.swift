            ...
            VStack {
                ...
                ZStack(alignment: .topLeading) {
                    ...
                    VStack(alignment: .trailing){
                        HStack {
                            Image(systemName: "heart").frame(width: 55.0, height: 55.0, alignment: .center).background(MiamColor.sharedInstance.musterd).foregroundColor(MiamColor.sharedInstance.primaryText)
