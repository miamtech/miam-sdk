...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)createRecipeLikeRecipeId:(NSString *)recipeId completionHandler:(void (^)(MiamCoreRecipeLike * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("createRecipeLike(recipeId:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)emitEffectLe:(MiamCoreLikeEffect *)le completionHandler:(void (^)(MiamCoreKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("emitEffect(le:completionHandler:)")));
