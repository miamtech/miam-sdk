...
@class MiamCoreKotlinx_coroutines_coreCoroutineDispatcher, MiamCoreKotlinAbstractCoroutineContextElement, MiamCoreKotlinx_coroutines_coreCoroutineDispatcherKey, MiamCoreMainLoopDispatcher, MiamCoreKotlinUnit, MiamCoreAttributesCompanion, MiamCoreKotlinArray<T>, MiamCoreRecordCompanion, MiamCoreKotlinx_serialization_jsonJsonElement, MiamCoreAttributes, MiamCoreRelationships, MiamCoreRecord, MiamCoreBasketCompanion, MiamCoreBasketAttributes, MiamCoreBasketRelationships, MiamCoreRecipe, MiamCoreBasket, MiamCoreBasketEntry, MiamCoreBasketCompletion, MiamCoreBasketAttributesCompanion, MiamCoreBasketCompletionCompanion, MiamCoreBasketEntriesItemCompanion, MiamCoreBasketEntriesItem, MiamCoreBasketEntryCompanion, MiamCoreBasketEntryAttributes, MiamCoreBasketEntryRelationships, MiamCoreItem, MiamCoreBasketEntryAttributesCompanion, MiamCoreRelationshipListCompanion, MiamCoreRelationshipList, MiamCoreBasketEntryRelationshipListCompanion, MiamCoreBasketEntryRelationshipListSerializer, MiamCoreBasketEntryRelationshipList, MiamCoreRelationshipsCompanion, MiamCoreItemRelationshipList, MiamCoreGroceriesEntryRelationship, MiamCoreBasketEntryRelationshipsCompanion, MiamCoreLineEntries, MiamCoreBasketPreviewLineCompanion, MiamCoreBasketPreviewLine, MiamCoreGroceriesList, MiamCoreBasketRelationshipsCompanion, MiamCoreCatalogFilterOptions, MiamCoreGroceriesEntryCompanion, MiamCoreGroceriesEntryAttributes, MiamCoreGroceriesEntryRelationships, MiamCoreGroceriesEntry, MiamCoreGroceriesEntryAttributesCompanion, MiamCoreRelationshipCompanion, MiamCoreRelationship, MiamCoreGroceriesEntryRelationshipCompanion, MiamCoreGroceriesEntryRelationshipListCompanion, MiamCoreGroceriesEntryRelationshipListSerializer, MiamCoreGroceriesEntryRelationshipList, MiamCoreGroceriesEntryRelationshipSerializer, MiamCoreGroceriesEntryRelationshipsCompanion, MiamCoreGroceriesListCompanion, MiamCoreGroceriesListAttributes, MiamCoreGroceriesListRelationships, MiamCoreRecipeInfos, MiamCoreGroceriesListAttributesCompanion, MiamCoreGroceriesListRelationshipsCompanion, MiamCoreIngredientCompanion, MiamCoreIngredientAttributes, MiamCoreIngredientRelationships, MiamCoreIngredient, MiamCoreIngredientAttributesCompanion, MiamCoreIngredientListRelationshipCompanion, MiamCoreIngredientListSerializer, MiamCoreIngredientListRelationship, MiamCoreIngredientRelationshipsCompanion, MiamCoreItemCompanion, MiamCoreItemAttributes, MiamCoreItemRelationships, MiamCoreItemAttributesCompanion, MiamCoreItemRelationshipListCompanion, MiamCoreItemRelationshipListSerializer, MiamCoreItemRelationshipsCompanion, MiamCorePackageCompanion, MiamCorePackageAttributes, MiamCorePackageRelationships, MiamCorePackage, MiamCorePackageSettings, MiamCorePackageAttributesCompanion, MiamCoreRecipeRelationshipList, MiamCorePackageRelationshipsCompanion, MiamCorePackageSettingsCompanion, MiamCorePointOfSaleAttributes, MiamCorePointOfSaleCompanion, MiamCorePointOfSale, MiamCorePointOfSaleSettings, MiamCoreSupplier, MiamCorePointOfSaleAttributesCompanion, MiamCorePointOfSaleOptionCompanion, MiamCorePointOfSaleOption, MiamCorePointOfSaleSettingsCompanion, MiamCorePointOfSaleWrapperCompanion, MiamCorePointOfSaleWrapper, MiamCorePointOfSalesCompanion, MiamCorePointOfSales, MiamCorePricingCompanion, MiamCorePricing, MiamCoreRecipeCompanion, MiamCoreRecipeAttributes, MiamCoreRecipeRelationships, MiamCoreRecipeLike, MiamCoreRecipeStep, MiamCoreRecipeAttributesCompanion, MiamCoreRecipeInfosCompanion, MiamCoreRecipeLikeCompanion, MiamCoreRecipeLikeAttributes, MiamCoreRecipeLikeRelationships, MiamCoreRecipeLikeAttributesCompanion, MiamCoreRecipeLikeRelationshipsCompanion, MiamCoreRecipeProviderCompanion, MiamCoreRecipeProviderAttributes, MiamCoreRecipeProviderRelationships, MiamCoreRecipeProvider, MiamCoreRecipeProviderAttributesCompanion, MiamCoreRecipeProviderRelationshipCompanion, MiamCoreRecipeProviderRelationshipsCompanion, MiamCoreRecipeProviderSerializer, MiamCoreRecipeProviderRelationship, MiamCoreRecipeRelationshipListCompanion, MiamCoreRecipeRelationshipListSerializer, MiamCoreRecipeStatusRelationship, MiamCoreSponsorListRelationship, MiamCoreRecipeStepListRelationship, MiamCoreRecipeTypeRelationship, MiamCoreRecipeRelationshipsCompanion, MiamCoreRecipeStatusCompanion, MiamCoreRecipeStatusAttributes, MiamCoreRecipeStatusRelationships, MiamCoreRecipeStatus, MiamCoreRecipeStatusAttributesCompanion, MiamCoreRecipeStatusRelationshipCompanion, MiamCoreRecipeStatusRelationshipsCompanion, MiamCoreRecipeStatusSerializer, MiamCoreRecipeStepCompanion, MiamCoreRecipeStepAttributes, MiamCoreRecipeStepRelationships, MiamCoreRecipeStepAttributesCompanion, MiamCoreRecipeStepListListSerializer, MiamCoreRecipeStepListRelationshipCompanion, MiamCoreRecipeStepRelationshipsCompanion, MiamCoreRecipeTypeCompanion, MiamCoreRecipeTypeAttributes, MiamCoreRecipeTypeRelationships, MiamCoreRecipeType, MiamCoreRecipeTypeAttributesCompanion, MiamCoreRecipeTypeRelationshipCompanion, MiamCoreRecipeTypeRelationshipsCompanion, MiamCoreRecipeTypeSerializer, MiamCoreRecordLink, MiamCoreRecordCounterWrapperCompanion, MiamCoreRecordCounterWrapper, MiamCoreRecordLinkCompanion, MiamCoreRecordWrapperCompanion, MiamCoreRecordWrapper, MiamCoreRetailerProduct, MiamCoreSponsorCompanion, MiamCoreSponsorAttributes, MiamCoreSponsorRelationships, MiamCoreSponsor, MiamCoreSponsorAttributesCompanion, MiamCoreSponsorListRelationshipCompanion, MiamCoreSponsorListSerializer, MiamCoreSponsorRelationshipsCompanion, MiamCoreSuggestionsCriteriaCompanion, MiamCoreSuggestionsCriteria, MiamCoreSupplierAttributes, MiamCoreSupplierCompanion, MiamCoreSupplierAttributesCompanion, MiamCoreSupplierNotificationWrapperCompanion, MiamCoreSupplierNotificationWrapper, MiamCoreSupplierWrapperCompanion, MiamCoreSupplierWrapper, MiamCoreDurationSerializer, MiamCoreMiamAPIDatasource, MiamCoreKoin_coreKoin, MiamCoreRecipeRepositoryImpCompanion, MiamCoreHttpRoutes, MiamCoreKotlinEnumCompanion, MiamCoreKotlinEnum<E>, MiamCoreRouterContent, MiamCoreRouterOutletContractEvent, MiamCoreRouterOutletContractEventCloseDialog, MiamCoreRouterOutletContractEventCloseDialogFromPreview, MiamCoreRecipeViewModel, MiamCoreRouterOutletContractEventGoToDetail, MiamCoreRouterOutletContractEventGoToDetailFromPreview, MiamCoreRouterOutletContractEventGoToHelper, MiamCoreRouterOutletContractEventGoToItemSelector, MiamCoreRouterOutletContractEventGoToPreview, MiamCoreRouterOutletContractEventGoToSponsor, MiamCoreRouterOutletContractEventOpenDialog, MiamCoreRouterOutletContractEventSetRouterContent, MiamCoreBasketPreviewViewModel, MiamCoreRouterOutletContractState, MiamCoreKotlinThrowable, MiamCoreMainIoExecutor, MiamCoreBaseViewModel<Event, State, Effect>, MiamCoreRouterOutletContractEffect, MiamCoreBasketPreviewContractEvent, MiamCoreBasketPreviewContractEventAddEntry, MiamCoreBasketPreviewContractEventAddGuest, MiamCoreBasketPreviewContractEventCloseItemSelector, MiamCoreBasketPreviewContractEventKillJob, MiamCoreBasketPreviewContractEventOpenItemSelector, MiamCoreBasketPreviewContractEventReload, MiamCoreBasketPreviewContractEventRemoveEntry, MiamCoreBasketPreviewContractEventRemoveGuest, MiamCoreBasketPreviewContractEventRemoveRecipe, MiamCoreBasketPreviewContractEventReplaceItem, MiamCoreBasketPreviewContractEventSetLines, MiamCoreBasketPreviewContractEventSetRecipeId, MiamCoreBasketPreviewContractEventToggleLine, MiamCoreBasketPreviewContractEventUpdateBasketEntry, MiamCoreBasicUiState<__covariant T>, MiamCoreBasketPreviewContractState, MiamCoreBasketPreviewContractEffect, MiamCoreItemSelectorContractEvent, MiamCoreItemSelectorContractEventReturnToBasketPreview, MiamCoreItemSelectorContractEventSelectNewItem, MiamCoreItemSelectorContractEventSetItemList, MiamCoreItemSelectorContractEventSetReplaceItemInPreview, MiamCoreItemSelectorContractEventSetReturnToBasketPreview, MiamCoreItemSelectorContractEventSetSelectedItem, MiamCoreItemSelectorContractState, MiamCoreItemSelectorInstance, MiamCoreItemSelectorViewModel, MiamCoreItemSelectorContractEffect, MiamCoreFavoritePageContractEvent, MiamCoreFavoritePageContractEventLoadPage, MiamCoreFavoritePageContractState, MiamCoreFavoritePageViewModelCompanion, MiamCoreFavoritePageContractEffect, MiamCoreMyMealContractEvent, MiamCoreMyMealContractEventRemoveRecipe, MiamCoreMyMealContractState, MiamCoreMyMealContractEffect, MiamCorePricingContractEvent, MiamCorePricingContractEventOnPriceUpdate, MiamCorePricingContractEventOnSetRecipe, MiamCorePricingContractEventSetDirectPrice, MiamCorePricingContractEventSetPrice, MiamCorePricingContractState, MiamCorePricingContractEffect, MiamCoreRecipeListPageContractEvent, MiamCoreRecipeListPageContractEventInitPage, MiamCoreRecipeListPageContractEventLoadPage, MiamCoreRecipeListPageContractState, MiamCoreRecipeListPageContractEffect, MiamCoreBasketTagContractEvent, MiamCoreBasketTagContractEventSetRetailerProductId, MiamCoreBasketTagContractState, MiamCoreRouterOutletViewModel, MiamCoreBasketTagContractEffect, MiamCoreCatalogFilterContractEvent, MiamCoreCatalogFilterContractEventOnCostFilterChanged, MiamCoreCatalogFilterContractEventOnDifficultyChanged, MiamCoreCatalogFilterContractEventOnTimeFilterChanged, MiamCoreCatalogFilterContractEventSetSearchString, MiamCoreCatalogFilterContractState, MiamCoreCatalogFilterContractEffect, MiamCoreRecipeContractEffect, MiamCoreRecipeContractEffectHideCard, MiamCoreRecipeContractEvent, MiamCoreRecipeContractEventDecreaseGuest, MiamCoreRecipeContractEventError, MiamCoreRecipeContractEventIncreaseGuest, MiamCoreRecipeContractEventOnAddRecipe, MiamCoreRecipeContractEventOnFetchRecipe, MiamCoreRecipeContractEventOnSetCriteria, MiamCoreRecipeContractEventOnSetRecipe, MiamCoreRecipeContractEventOnToggleLike, MiamCoreRecipeContractEventOnUnbind, MiamCoreRecipeContractEventSetActiveStep, MiamCoreRecipeContractEventSetHeader, MiamCoreRecipeContractEventShowIngredient, MiamCoreRecipeContractEventShowSteps, MiamCoreRecipeContractEventUpdateGuest, MiamCoreTabEnum, MiamCoreRecipeContractState, MiamCoreGroceriesListStore, MiamCoreCatalogContent, MiamCoreCatalogContractEvent, MiamCoreCatalogContractEventGoToDefault, MiamCoreCatalogContractEventGoToFavorite, MiamCoreCatalogContractEventGoToRecipeList, MiamCoreCatalogContractEventGoToRecipeListFromCategory, MiamCoreCatalogContractEventOnFilterValidation, MiamCoreCatalogContractEventOnSearchLaunch, MiamCoreCatalogContractEventToggleFilter, MiamCoreCatalogContractEventToggleSearch, MiamCoreCatalogFilterViewModel, MiamCoreRecipeListPageViewModel, MiamCoreCatalogContractState, MiamCoreCatalogContractEffect, MiamCoreAlterQuantityBasketEntry, MiamCoreBasicUiStateEmpty, MiamCoreKotlinNothing, MiamCoreBasicUiStateError, MiamCoreBasicUiStateIdle, MiamCoreBasicUiStateLoading, MiamCoreBasicUiStateSuccess<T>, MiamCoreBasketAction, MiamCoreBasketActionAddBasketEntry, MiamCoreBasketActionConfirmBasket, MiamCoreBasketActionRefreshBasket, MiamCoreBasketActionRemoveEntry, MiamCoreBasketActionReplaceSelectedItem, MiamCoreBasketActionUpdateBasketEntries, MiamCoreBasketActionUpdateBasketEntriesDiff, MiamCoreBasketEffect, MiamCoreBasketEffectBasketConfirmed, MiamCoreBasketEffectBasketPreviewChange, MiamCoreBasketState, MiamCoreGroceriesListAction, MiamCoreGroceriesListActionAlterRecipeList, MiamCoreGroceriesListActionRefreshGroceriesList, MiamCoreGroceriesListActionRemoveRecipe, MiamCoreGroceriesListActionResetGroceriesList, MiamCoreGroceriesListEffect, MiamCoreGroceriesListEffectGroceriesListLoaded, MiamCoreGroceriesListEffectRecipeAdded, MiamCoreGroceriesListEffectRecipeCountChanged, MiamCoreGroceriesListEffectRecipeRemoved, MiamCoreGroceriesListState, MiamCorePointOfSaleAction, MiamCorePointOfSaleActionSetExtId, MiamCorePointOfSaleActionSetSupplierId, MiamCorePointOfSaleState, MiamCoreUserAction, MiamCoreUserActionRefreshUser, MiamCoreUserState, MiamCoreExecutorHelperCompanion, MiamCoreReadyEvent, MiamCoreContextHandlerInstance, MiamCoreContextHandler, MiamCoreContextHandlerState, MiamCoreGroceriesListHandler, MiamCoreLogHandlerCompanion, MiamCorePointOfSaleHandler, MiamCoreReadyEventIsNotReady, MiamCoreReadyEventIsReady, MiamCoreUserHandler, MiamCoreBasketComparisonItem, MiamCoreBasketComparator, MiamCoreBasketComparatorData, MiamCoreBasketHandlerInstance, MiamCoreBasketHandler, MiamCoreBasketHandlerState, MiamCoreKoin_coreKoinApplication, MiamCoreKoin_coreModule, MiamCoreKotlinx_serialization_jsonJson, MiamCoreKotlinAbstractCoroutineContextKey<B, E>, MiamCoreKotlinException, MiamCoreKotlinRuntimeException, MiamCoreKotlinIllegalStateException, MiamCoreKotlinx_serialization_jsonJsonElementCompanion, MiamCoreKotlinx_serialization_coreSerializersModule, MiamCoreKotlinx_serialization_coreSerialKind, MiamCoreKoin_coreScope, MiamCoreKoin_coreParametersHolder, MiamCoreKotlinLazyThreadSafetyMode, MiamCoreKoin_coreLogger, MiamCoreKoin_coreInstanceRegistry, MiamCoreKoin_corePropertyRegistry, MiamCoreKoin_coreScopeRegistry, MiamCoreKotlinCancellationException, MiamCoreKoin_coreKoinApplicationCompanion, MiamCoreKoin_coreLevel, MiamCoreKoin_coreInstanceFactory<T>, MiamCoreKotlinPair<__covariant A, __covariant B>, MiamCoreKoin_coreScopeDSL, MiamCoreKoin_coreSingleInstanceFactory<T>, MiamCoreKotlinx_serialization_jsonJsonConfiguration, MiamCoreKotlinx_serialization_jsonJsonDefault, MiamCoreKoin_coreParametersHolderCompanion, MiamCoreKoin_coreScopeRegistryCompanion, MiamCoreKoin_coreBeanDefinition<T>, MiamCoreKoin_coreInstanceFactoryCompanion, MiamCoreKoin_coreInstanceContext, MiamCoreKotlinx_coroutines_coreAtomicDesc, MiamCoreKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, MiamCoreKoin_coreKind, MiamCoreKoin_coreCallbacks<T>, MiamCoreKotlinx_coroutines_coreAtomicOp<__contravariant T>, MiamCoreKotlinx_coroutines_coreOpDescriptor, MiamCoreKotlinx_coroutines_coreLockFreeLinkedListNode, MiamCoreKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, MiamCoreKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, MiamCoreKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol MiamCoreKotlinCoroutineContextKey, MiamCoreKotlinCoroutineContextElement, MiamCoreKotlinCoroutineContext, MiamCoreKotlinContinuation, MiamCoreKotlinContinuationInterceptor, MiamCoreKotlinx_coroutines_coreRunnable, MiamCoreKotlinx_coroutines_coreFlow, MiamCoreKotlinx_serialization_coreKSerializer, MiamCoreBasketPreviewEntry, MiamCoreKotlinKClass, MiamCoreKotlinx_serialization_coreEncoder, MiamCoreKotlinx_serialization_coreSerialDescriptor, MiamCoreKotlinx_serialization_coreSerializationStrategy, MiamCoreKotlinx_serialization_coreDecoder, MiamCoreKotlinx_serialization_coreDeserializationStrategy, MiamCoreBasketEntryRepository, MiamCoreBasketRepository, MiamCoreKoin_coreKoinComponent, MiamCoreGroceriesEntryRepository, MiamCoreGroceriesListRepository, MiamCorePackageRepository, MiamCorePointOfSaleRepository, MiamCorePricingRepository, MiamCoreRecipeRepository, MiamCoreRecipeDataSource, MiamCoreGroceriesListDataSource, MiamCorePointOfSaleDataSource, MiamCoreBasketDataSource, MiamCorePricingDataSource, MiamCoreBasketEntryDataSource, MiamCoreGrocerieEntryDataSource, MiamCoreSupplierDataSource, MiamCorePackageDataSource, MiamCoreKotlinComparable, MiamCoreUiEffect, MiamCoreUiEvent, MiamCoreUiState, MiamCoreIExecutorScope, MiamCoreKotlinx_coroutines_coreCoroutineScope, MiamCoreKotlinx_coroutines_coreSharedFlow, MiamCoreKotlinx_coroutines_coreStateFlow, MiamCoreKotlinx_coroutines_coreJob, MiamCoreAction, MiamCoreEffect, MiamCoreState, MiamCoreKotlinx_coroutines_coreMutableStateFlow, MiamCoreStore, MiamCoreKotlinx_coroutines_coreFlowCollector, MiamCoreKotlinIterator, MiamCoreKotlinKDeclarationContainer, MiamCoreKotlinKAnnotatedElement, MiamCoreKotlinKClassifier, MiamCoreKotlinx_serialization_coreCompositeEncoder, MiamCoreKotlinAnnotation, MiamCoreKotlinx_serialization_coreCompositeDecoder, MiamCoreKoin_coreKoinScopeComponent, MiamCoreKoin_coreQualifier, MiamCoreKotlinLazy, MiamCoreKotlinx_coroutines_coreChildHandle, MiamCoreKotlinx_coroutines_coreChildJob, MiamCoreKotlinx_coroutines_coreDisposableHandle, MiamCoreKotlinSequence, MiamCoreKotlinx_coroutines_coreSelectClause0, MiamCoreKotlinx_coroutines_coreMutableSharedFlow, MiamCoreKotlinx_serialization_coreSerialFormat, MiamCoreKotlinx_serialization_coreStringFormat, MiamCoreKotlinx_serialization_coreSerializersModuleCollector, MiamCoreKoin_coreScopeCallback, MiamCoreKotlinx_coroutines_coreParentJob, MiamCoreKotlinx_coroutines_coreSelectInstance, MiamCoreKotlinSuspendFunction0, MiamCoreKotlinFunction;
...
@protocol MiamCoreUseCase
@required
- (id<MiamCoreKotlinx_coroutines_coreFlow>)execute __attribute__((swift_name("execute()")));
@end;

__attribute__((swift_name("UseCaseIn")))
@protocol MiamCoreUseCaseIn
@required
...
*/
- (void)executeParam:(id _Nullable)param completionHandler:(void (^)(MiamCoreKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("execute(param:completionHandler:)")));
@end;

__attribute__((swift_name("UseCaseInOut")))
@protocol MiamCoreUseCaseInOut
@required
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)executeParam:(id _Nullable)param completionHandler_:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("execute(param:completionHandler_:)")));
@end;

__attribute__((swift_name("UseCaseOut")))
@protocol MiamCoreUseCaseOut
@required
- (id<MiamCoreKotlinx_coroutines_coreFlow>)execute __attribute__((swift_name("execute()")));
@end;
...
- (MiamCoreFloat * _Nullable)component4 __attribute__((swift_name("component4()")));
...
@property (readonly) MiamCoreFloat * _Nullable totalPrice __attribute__((swift_name("totalPrice")));
@end;
...
- (instancetype)initWithName:(NSString * _Nullable)name quantity:(NSString * _Nullable)quantity unit:(NSString * _Nullable)unit active:(BOOL)active forcedEans:(NSArray<NSString *> * _Nullable)forcedEans __attribute__((swift_name("init(name:quantity:unit:active:forcedEans:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (MiamCoreIngredientAttributes *)doCopyName:(NSString * _Nullable)name quantity:(NSString * _Nullable)quantity unit:(NSString * _Nullable)unit active:(BOOL)active forcedEans:(NSArray<NSString *> * _Nullable)forcedEans __attribute__((swift_name("doCopy(name:quantity:unit:active:forcedEans:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithTitle:(NSString *)title authorId:(NSString *)authorId editable:(MiamCoreBoolean * _Nullable)editable shared:(MiamCoreBoolean * _Nullable)shared catalogCategory:(MiamCoreBoolean * _Nullable)catalogCategory catalogPosition:(MiamCoreInt * _Nullable)catalogPosition recipesCount:(int32_t)recipesCount settings:(MiamCorePackageSettings *)settings __attribute__((swift_name("init(title:authorId:editable:shared:catalogCategory:catalogPosition:recipesCount:settings:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (MiamCorePackageAttributes *)doCopyTitle:(NSString *)title authorId:(NSString *)authorId editable:(MiamCoreBoolean * _Nullable)editable shared:(MiamCoreBoolean * _Nullable)shared catalogCategory:(MiamCoreBoolean * _Nullable)catalogCategory catalogPosition:(MiamCoreInt * _Nullable)catalogPosition recipesCount:(int32_t)recipesCount settings:(MiamCorePackageSettings *)settings __attribute__((swift_name("doCopy(title:authorId:editable:shared:catalogCategory:catalogPosition:recipesCount:settings:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *costLabel __attribute__((swift_name("costLabel")));
@property (readonly) NSString *difficultyLabel __attribute__((swift_name("difficultyLabel")));
@property (readonly) NSString *id __attribute__((swift_name("id")));
...
- (instancetype)initWithLinks:(MiamCoreRecordLink *)links __attribute__((swift_name("init(links:)"))) __attribute__((objc_designated_initializer));
...
- (MiamCoreRecordCounterWrapper *)doCopyLinks:(MiamCoreRecordLink *)links __attribute__((swift_name("doCopy(links:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getFromListAndPosListId:(NSString *)listId posId:(int32_t)posId completionHandler:(void (^)(MiamCoreBasket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getFromListAndPos(listId:posId:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getActivePackageForRetailerRetailerId:(NSString *)retailerId completionHandler:(void (^)(NSArray<MiamCorePackage *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getActivePackageForRetailer(retailerId:completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPosFormExtIdExtId:(NSString *)extId supplierId:(int32_t)supplierId completionHandler:(void (^)(MiamCorePointOfSale * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPosFormExtId(extId:supplierId:completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRecipePriceRecipeId:(NSString *)recipeId posId:(int32_t)posId completionHandler:(void (^)(MiamCorePricing * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRecipePrice(recipeId:posId:completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRecipeSuggestionsSupplierId:(int32_t)supplierId criteria:(MiamCoreSuggestionsCriteria *)criteria completionHandler:(void (^)(MiamCoreRecipe * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRecipeSuggestions(supplierId:criteria:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)addRecipeLikeRecipe:(MiamCoreRecipe *)recipe completionHandler:(void (^)(MiamCoreRecipe * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("addRecipeLike(recipe:completionHandler:)")));

/**
 @note This method converts instances of CancellationException to errors.
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)addRecipeLikesRecipeList:(NSArray<MiamCoreRecipe *> *)recipeList completionHandler:(void (^)(NSArray<MiamCoreRecipe *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("addRecipeLikes(recipeList:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)toggleLikeRecipe:(MiamCoreRecipe *)recipe completionHandler:(void (^)(MiamCoreRecipe * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("toggleLike(recipe:completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getFromListAndPosListId:(NSString *)listId posId:(int32_t)posId included:(NSArray<NSString *> *)included completionHandler:(void (^)(MiamCoreBasket * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getFromListAndPos(listId:posId:included:completionHandler:)")));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getRecipePriceIdRecipe:(NSString *)idRecipe idPos:(int32_t)idPos completionHandler:(void (^)(MiamCorePricing * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRecipePrice(idRecipe:idPos:completionHandler:)")));
@end;
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getActivePackagesFromSupplierIDSupplierId:(NSString *)supplierId completionHandler:(void (^)(NSArray<MiamCorePackage *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getActivePackagesFromSupplierID(supplierId:completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MiamAPIDatasource")))
@interface MiamCoreMiamAPIDatasource : MiamCoreBase <MiamCoreRecipeDataSource, MiamCoreGroceriesListDataSource, MiamCorePointOfSaleDataSource, MiamCoreBasketDataSource, MiamCorePricingDataSource, MiamCoreBasketEntryDataSource, MiamCoreGrocerieEntryDataSource, MiamCoreSupplierDataSource, MiamCorePackageDataSource, MiamCoreKoin_coreKoinComponent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RouterOutletContractEvent.CloseDialog")))
@interface MiamCoreRouterOutletContractEventCloseDialog : MiamCoreRouterOutletContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)closeDialog __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreRouterOutletContractEventCloseDialog *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RouterOutletContractEvent.CloseDialogFromPreview")))
@interface MiamCoreRouterOutletContractEventCloseDialogFromPreview : MiamCoreRouterOutletContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)closeDialogFromPreview __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreRouterOutletContractEventCloseDialogFromPreview *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RouterOutletContractEvent.GoToDetailFromPreview")))
@interface MiamCoreRouterOutletContractEventGoToDetailFromPreview : MiamCoreRouterOutletContractEvent
- (instancetype)initWithVm:(MiamCoreRecipeViewModel *)vm __attribute__((swift_name("init(vm:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreRecipeViewModel *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRouterOutletContractEventGoToDetailFromPreview *)doCopyVm:(MiamCoreRecipeViewModel *)vm __attribute__((swift_name("doCopy(vm:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreRecipeViewModel *vm __attribute__((swift_name("vm")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RouterOutletContractEvent.SetRouterContent")))
@interface MiamCoreRouterOutletContractEventSetRouterContent : MiamCoreRouterOutletContractEvent
- (instancetype)initWithRouterContent:(MiamCoreRouterContent *)routerContent __attribute__((swift_name("init(routerContent:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreRouterContent *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRouterOutletContractEventSetRouterContent *)doCopyRouterContent:(MiamCoreRouterContent *)routerContent __attribute__((swift_name("doCopy(routerContent:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreRouterContent *routerContent __attribute__((swift_name("routerContent")));
@end;
...
- (instancetype)initWithContent:(MiamCoreRouterContent *)content rvm:(MiamCoreRecipeViewModel * _Nullable)rvm bpvm:(MiamCoreBasketPreviewViewModel * _Nullable)bpvm recipeId:(NSString * _Nullable)recipeId isOpen:(BOOL)isOpen showFooter:(BOOL)showFooter __attribute__((swift_name("init(content:rvm:bpvm:recipeId:isOpen:showFooter:)"))) __attribute__((objc_designated_initializer));
- (MiamCoreRouterContent *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRecipeViewModel * _Nullable)component2 __attribute__((swift_name("component2()")));
- (MiamCoreBasketPreviewViewModel * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (BOOL)component5 __attribute__((swift_name("component5()")));
- (BOOL)component6 __attribute__((swift_name("component6()")));
- (MiamCoreRouterOutletContractState *)doCopyContent:(MiamCoreRouterContent *)content rvm:(MiamCoreRecipeViewModel * _Nullable)rvm bpvm:(MiamCoreBasketPreviewViewModel * _Nullable)bpvm recipeId:(NSString * _Nullable)recipeId isOpen:(BOOL)isOpen showFooter:(BOOL)showFooter __attribute__((swift_name("doCopy(content:rvm:bpvm:recipeId:isOpen:showFooter:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreBasketPreviewViewModel * _Nullable bpvm __attribute__((swift_name("bpvm")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPreviewContractEvent.AddGuest")))
@interface MiamCoreBasketPreviewContractEventAddGuest : MiamCoreBasketPreviewContractEvent
- (instancetype)initWithRecipeVm:(MiamCoreRecipeViewModel *)recipeVm __attribute__((swift_name("init(recipeVm:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreRecipeViewModel *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreBasketPreviewContractEventAddGuest *)doCopyRecipeVm:(MiamCoreRecipeViewModel *)recipeVm __attribute__((swift_name("doCopy(recipeVm:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreRecipeViewModel *recipeVm __attribute__((swift_name("recipeVm")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPreviewContractEvent.Reload")))
@interface MiamCoreBasketPreviewContractEventReload : MiamCoreBasketPreviewContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)reload __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreBasketPreviewContractEventReload *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPreviewContractEvent.RemoveEntry")))
@interface MiamCoreBasketPreviewContractEventRemoveEntry : MiamCoreBasketPreviewContractEvent
- (instancetype)initWithEntry:(MiamCoreBasketEntry *)entry __attribute__((swift_name("init(entry:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreBasketEntry *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreBasketPreviewContractEventRemoveEntry *)doCopyEntry:(MiamCoreBasketEntry *)entry __attribute__((swift_name("doCopy(entry:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreBasketEntry *entry __attribute__((swift_name("entry")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPreviewContractEvent.RemoveGuest")))
@interface MiamCoreBasketPreviewContractEventRemoveGuest : MiamCoreBasketPreviewContractEvent
- (instancetype)initWithRecipeVm:(MiamCoreRecipeViewModel *)recipeVm __attribute__((swift_name("init(recipeVm:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreRecipeViewModel *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreBasketPreviewContractEventRemoveGuest *)doCopyRecipeVm:(MiamCoreRecipeViewModel *)recipeVm __attribute__((swift_name("doCopy(recipeVm:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreRecipeViewModel *recipeVm __attribute__((swift_name("recipeVm")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BasketPreviewContractEvent.UpdateBasketEntry")))
@interface MiamCoreBasketPreviewContractEventUpdateBasketEntry : MiamCoreBasketPreviewContractEvent
- (instancetype)initWithEntry:(MiamCoreBasketEntry *)entry finalQty:(int32_t)finalQty __attribute__((swift_name("init(entry:finalQty:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreBasketEntry *)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (MiamCoreBasketPreviewContractEventUpdateBasketEntry *)doCopyEntry:(MiamCoreBasketEntry *)entry finalQty:(int32_t)finalQty __attribute__((swift_name("doCopy(entry:finalQty:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreBasketEntry *entry __attribute__((swift_name("entry")));
@property (readonly) int32_t finalQty __attribute__((swift_name("finalQty")));
@end;
...
- (instancetype)initWithRecipeId:(MiamCoreInt * _Nullable)recipeId showLines:(BOOL)showLines line:(MiamCoreBasicUiState<MiamCoreBasketPreviewLine *> *)line lineUpdates:(NSArray<MiamCoreBasketEntry *> *)lineUpdates bpl:(MiamCoreBasketPreviewLine * _Nullable)bpl isReloading:(BOOL)isReloading job:(id<MiamCoreKotlinx_coroutines_coreJob> _Nullable)job __attribute__((swift_name("init(recipeId:showLines:line:lineUpdates:bpl:isReloading:job:)"))) __attribute__((objc_designated_initializer));
- (MiamCoreInt * _Nullable)component1 __attribute__((swift_name("component1()")));
- (BOOL)component2 __attribute__((swift_name("component2()")));
- (MiamCoreBasicUiState<MiamCoreBasketPreviewLine *> *)component3 __attribute__((swift_name("component3()")));
- (NSArray<MiamCoreBasketEntry *> *)component4 __attribute__((swift_name("component4()")));
- (MiamCoreBasketPreviewLine * _Nullable)component5 __attribute__((swift_name("component5()")));
- (BOOL)component6 __attribute__((swift_name("component6()")));
- (id<MiamCoreKotlinx_coroutines_coreJob> _Nullable)component7 __attribute__((swift_name("component7()")));
- (MiamCoreBasketPreviewContractState *)doCopyRecipeId:(MiamCoreInt * _Nullable)recipeId showLines:(BOOL)showLines line:(MiamCoreBasicUiState<MiamCoreBasketPreviewLine *> *)line lineUpdates:(NSArray<MiamCoreBasketEntry *> *)lineUpdates bpl:(MiamCoreBasketPreviewLine * _Nullable)bpl isReloading:(BOOL)isReloading job:(id<MiamCoreKotlinx_coroutines_coreJob> _Nullable)job __attribute__((swift_name("doCopy(recipeId:showLines:line:lineUpdates:bpl:isReloading:job:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PricingContractEvent.OnPriceUpdate")))
@interface MiamCorePricingContractEventOnPriceUpdate : MiamCorePricingContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)onPriceUpdate __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCorePricingContractEventOnPriceUpdate *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PricingContractEvent.OnSetRecipe")))
@interface MiamCorePricingContractEventOnSetRecipe : MiamCorePricingContractEvent
- (instancetype)initWithIdRecipe:(NSString *)idRecipe guestNumber:(int32_t)guestNumber __attribute__((swift_name("init(idRecipe:guestNumber:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (MiamCorePricingContractEventOnSetRecipe *)doCopyIdRecipe:(NSString *)idRecipe guestNumber:(int32_t)guestNumber __attribute__((swift_name("doCopy(idRecipe:guestNumber:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t guestNumber __attribute__((swift_name("guestNumber")));
@property (readonly) NSString *idRecipe __attribute__((swift_name("idRecipe")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PricingContractEvent.SetDirectPrice")))
@interface MiamCorePricingContractEventSetDirectPrice : MiamCorePricingContractEvent
- (instancetype)initWithPrice:(double)price __attribute__((swift_name("init(price:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (double)component1 __attribute__((swift_name("component1()")));
- (MiamCorePricingContractEventSetDirectPrice *)doCopyPrice:(double)price __attribute__((swift_name("doCopy(price:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double price __attribute__((swift_name("price")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PricingContractEvent.SetPrice")))
@interface MiamCorePricingContractEventSetPrice : MiamCorePricingContractEvent
- (instancetype)initWithPricing:(MiamCorePricing *)pricing __attribute__((swift_name("init(pricing:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCorePricing *)component1 __attribute__((swift_name("component1()")));
- (MiamCorePricingContractEventSetPrice *)doCopyPricing:(MiamCorePricing *)pricing __attribute__((swift_name("doCopy(pricing:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCorePricing *pricing __attribute__((swift_name("pricing")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PricingContractState")))
@interface MiamCorePricingContractState : MiamCoreBase <MiamCoreUiState>
- (instancetype)initWithPrice:(MiamCoreBasicUiState<MiamCorePricing *> *)price directPrice:(MiamCoreDouble * _Nullable)directPrice isInCart:(BOOL)isInCart recipeId:(NSString *)recipeId guestNumber:(int32_t)guestNumber integerPart:(NSString *)integerPart decimalPart:(NSString *)decimalPart __attribute__((swift_name("init(price:directPrice:isInCart:recipeId:guestNumber:integerPart:decimalPart:)"))) __attribute__((objc_designated_initializer));
- (MiamCoreBasicUiState<MiamCorePricing *> *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreDouble * _Nullable)component2 __attribute__((swift_name("component2()")));
- (BOOL)component3 __attribute__((swift_name("component3()")));
- (NSString *)component4 __attribute__((swift_name("component4()")));
- (int32_t)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
- (NSString *)component7 __attribute__((swift_name("component7()")));
- (MiamCorePricingContractState *)doCopyPrice:(MiamCoreBasicUiState<MiamCorePricing *> *)price directPrice:(MiamCoreDouble * _Nullable)directPrice isInCart:(BOOL)isInCart recipeId:(NSString *)recipeId guestNumber:(int32_t)guestNumber integerPart:(NSString *)integerPart decimalPart:(NSString *)decimalPart __attribute__((swift_name("doCopy(price:directPrice:isInCart:recipeId:guestNumber:integerPart:decimalPart:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *decimalPart __attribute__((swift_name("decimalPart")));
@property (readonly) MiamCoreDouble * _Nullable directPrice __attribute__((swift_name("directPrice")));
@property (readonly) int32_t guestNumber __attribute__((swift_name("guestNumber")));
@property (readonly) NSString *integerPart __attribute__((swift_name("integerPart")));
...
__attribute__((swift_name("PricingViewModel")))
@interface MiamCorePricingViewModel : MiamCoreBaseViewModel<MiamCorePricingContractEvent *, MiamCorePricingContractState *, MiamCorePricingContractEffect *>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
- (instancetype)initWithTitle:(NSString *)title filter:(NSString *)filter __attribute__((swift_name("init(title:filter:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (MiamCoreRecipeListPageContractEventInitPage *)doCopyTitle:(NSString *)title filter:(NSString *)filter __attribute__((swift_name("doCopy(title:filter:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((swift_name("CatalogFilterContract")))
@protocol MiamCoreCatalogFilterContract
@required
@end;

__attribute__((swift_name("CatalogFilterContractEffect")))
@interface MiamCoreCatalogFilterContractEffect : MiamCoreBase <MiamCoreUiEffect>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end;

__attribute__((swift_name("CatalogFilterContractEvent")))
@interface MiamCoreCatalogFilterContractEvent : MiamCoreBase <MiamCoreUiEvent>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogFilterContractEvent.OnCostFilterChanged")))
@interface MiamCoreCatalogFilterContractEventOnCostFilterChanged : MiamCoreCatalogFilterContractEvent
...
- (MiamCoreCatalogFilterContractEventOnCostFilterChanged *)doCopyCostFilter:(MiamCoreCatalogFilterOptions *)costFilter __attribute__((swift_name("doCopy(costFilter:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogFilterContractEvent.OnDifficultyChanged")))
@interface MiamCoreCatalogFilterContractEventOnDifficultyChanged : MiamCoreCatalogFilterContractEvent
...
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreCatalogFilterOptions *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreCatalogFilterContractEventOnDifficultyChanged *)doCopyDifficulty:(MiamCoreCatalogFilterOptions *)difficulty __attribute__((swift_name("doCopy(difficulty:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogFilterContractEvent.OnTimeFilterChanged")))
@interface MiamCoreCatalogFilterContractEventOnTimeFilterChanged : MiamCoreCatalogFilterContractEvent
...
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreCatalogFilterOptions *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreCatalogFilterContractEventOnTimeFilterChanged *)doCopyTimeFilter:(MiamCoreCatalogFilterOptions *)timeFilter __attribute__((swift_name("doCopy(timeFilter:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogFilterContractEvent.SetSearchString")))
@interface MiamCoreCatalogFilterContractEventSetSearchString : MiamCoreCatalogFilterContractEvent
...
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreCatalogFilterContractEventSetSearchString *)doCopySearchString:(NSString *)searchString __attribute__((swift_name("doCopy(searchString:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogFilterContractState")))
@interface MiamCoreCatalogFilterContractState : MiamCoreBase <MiamCoreUiState>
...
- (BOOL)component6 __attribute__((swift_name("component6()")));
- (NSString * _Nullable)component7 __attribute__((swift_name("component7()")));
- (MiamCoreCatalogFilterContractState *)doCopyNumberOfResult:(int32_t)numberOfResult difficulty:(NSArray<MiamCoreCatalogFilterOptions *> *)difficulty cost:(NSArray<MiamCoreCatalogFilterOptions *> *)cost time:(NSArray<MiamCoreCatalogFilterOptions *> *)time searchString:(NSString * _Nullable)searchString isFavorite:(BOOL)isFavorite category:(NSString * _Nullable)category __attribute__((swift_name("doCopy(numberOfResult:difficulty:cost:time:searchString:isFavorite:category:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface MiamCoreCatalogFilterViewModel : MiamCoreBaseViewModel<MiamCoreCatalogFilterContractEvent *, MiamCoreCatalogFilterContractState *, MiamCoreCatalogFilterContractEffect *>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)clearFilter __attribute__((swift_name("clearFilter()")));
- (MiamCoreCatalogFilterContractState *)createInitialState __attribute__((swift_name("createInitialState()")));
...
- (void)handleEventEvent:(MiamCoreCatalogFilterContractEvent *)event __attribute__((swift_name("handleEvent(event:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.DecreaseGuest")))
@interface MiamCoreRecipeContractEventDecreaseGuest : MiamCoreRecipeContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)decreaseGuest __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreRecipeContractEventDecreaseGuest *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.IncreaseGuest")))
@interface MiamCoreRecipeContractEventIncreaseGuest : MiamCoreRecipeContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)increaseGuest __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreRecipeContractEventIncreaseGuest *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.OnFetchRecipe")))
@interface MiamCoreRecipeContractEventOnFetchRecipe : MiamCoreRecipeContractEvent
- (instancetype)initWithIdRecipe:(NSString *)idRecipe __attribute__((swift_name("init(idRecipe:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRecipeContractEventOnFetchRecipe *)doCopyIdRecipe:(NSString *)idRecipe __attribute__((swift_name("doCopy(idRecipe:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *idRecipe __attribute__((swift_name("idRecipe")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.OnSetCriteria")))
@interface MiamCoreRecipeContractEventOnSetCriteria : MiamCoreRecipeContractEvent
- (instancetype)initWithCrieria:(MiamCoreSuggestionsCriteria *)crieria __attribute__((swift_name("init(crieria:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreSuggestionsCriteria *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRecipeContractEventOnSetCriteria *)doCopyCrieria:(MiamCoreSuggestionsCriteria *)crieria __attribute__((swift_name("doCopy(crieria:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreSuggestionsCriteria *crieria __attribute__((swift_name("crieria")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.OnSetRecipe")))
@interface MiamCoreRecipeContractEventOnSetRecipe : MiamCoreRecipeContractEvent
...
- (MiamCoreRecipeContractEventOnSetRecipe *)doCopyRecipe:(MiamCoreRecipe *)recipe __attribute__((swift_name("doCopy(recipe:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.OnToggleLike")))
@interface MiamCoreRecipeContractEventOnToggleLike : MiamCoreRecipeContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)onToggleLike __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreRecipeContractEventOnToggleLike *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.OnUnbind")))
@interface MiamCoreRecipeContractEventOnUnbind : MiamCoreRecipeContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)onUnbind __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreRecipeContractEventOnUnbind *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.SetHeader")))
@interface MiamCoreRecipeContractEventSetHeader : MiamCoreRecipeContractEvent
...
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRecipeContractEventSetHeader *)doCopyHeader:(NSString *)header __attribute__((swift_name("doCopy(header:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractEvent.UpdateGuest")))
@interface MiamCoreRecipeContractEventUpdateGuest : MiamCoreRecipeContractEvent
- (instancetype)initWithNbGuest:(int32_t)nbGuest __attribute__((swift_name("init(nbGuest:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (MiamCoreRecipeContractEventUpdateGuest *)doCopyNbGuest:(int32_t)nbGuest __attribute__((swift_name("doCopy(nbGuest:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t nbGuest __attribute__((swift_name("nbGuest")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RecipeContractState")))
@interface MiamCoreRecipeContractState : MiamCoreBase <MiamCoreUiState>
- (instancetype)initWithRecipeState:(MiamCoreBasicUiState<MiamCoreRecipe *> *)recipeState recipe:(MiamCoreRecipe * _Nullable)recipe headerText:(NSString *)headerText guest:(int32_t)guest isInCart:(BOOL)isInCart analyticsEventSent:(BOOL)analyticsEventSent isPriceDisplayed:(BOOL)isPriceDisplayed isInViewport:(BOOL)isInViewport tabState:(MiamCoreTabEnum *)tabState activeStep:(int32_t)activeStep recipeLoaded:(BOOL)recipeLoaded isLiked:(BOOL)isLiked likeIsEnable:(BOOL)likeIsEnable __attribute__((swift_name("init(recipeState:recipe:headerText:guest:isInCart:analyticsEventSent:isPriceDisplayed:isInViewport:tabState:activeStep:recipeLoaded:isLiked:likeIsEnable:)"))) __attribute__((objc_designated_initializer));
...
- (MiamCoreTabEnum *)component9 __attribute__((swift_name("component9()")));
- (MiamCoreRecipeContractState *)doCopyRecipeState:(MiamCoreBasicUiState<MiamCoreRecipe *> *)recipeState recipe:(MiamCoreRecipe * _Nullable)recipe headerText:(NSString *)headerText guest:(int32_t)guest isInCart:(BOOL)isInCart analyticsEventSent:(BOOL)analyticsEventSent isPriceDisplayed:(BOOL)isPriceDisplayed isInViewport:(BOOL)isInViewport tabState:(MiamCoreTabEnum *)tabState activeStep:(int32_t)activeStep recipeLoaded:(BOOL)recipeLoaded isLiked:(BOOL)isLiked likeIsEnable:(BOOL)likeIsEnable __attribute__((swift_name("doCopy(recipeState:recipe:headerText:guest:isInCart:analyticsEventSent:isPriceDisplayed:isInViewport:tabState:activeStep:recipeLoaded:isLiked:likeIsEnable:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
...
- (BOOL)isIntegerN:(float)N __attribute__((swift_name("isInteger(N:)")));
- (BOOL)isUnitCountlessUnit:(NSString * _Nullable)unit __attribute__((swift_name("isUnitCountless(unit:)")));
...
- (void)sendShowEventEventType:(NSString *)eventType __attribute__((swift_name("sendShowEvent(eventType:)")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) MiamCoreCatalogContent *recipeList __attribute__((swift_name("recipeList")));
@property (class, readonly) MiamCoreCatalogContent *default_ __attribute__((swift_name("default_")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.GoToDefault")))
@interface MiamCoreCatalogContractEventGoToDefault : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)goToDefault __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventGoToDefault *shared __attribute__((swift_name("shared")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.GoToRecipeList")))
@interface MiamCoreCatalogContractEventGoToRecipeList : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)goToRecipeList __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventGoToRecipeList *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.GoToRecipeListFromCategory")))
@interface MiamCoreCatalogContractEventGoToRecipeListFromCategory : MiamCoreCatalogContractEvent
- (instancetype)initWithCategory:(MiamCorePackage *)category __attribute__((swift_name("init(category:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (MiamCorePackage *)component1 __attribute__((swift_name("component1()")));
- (MiamCoreCatalogContractEventGoToRecipeListFromCategory *)doCopyCategory:(MiamCorePackage *)category __attribute__((swift_name("doCopy(category:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCorePackage *category __attribute__((swift_name("category")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.OnFilterValidation")))
@interface MiamCoreCatalogContractEventOnFilterValidation : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)onFilterValidation __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventOnFilterValidation *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.OnSearchLaunch")))
@interface MiamCoreCatalogContractEventOnSearchLaunch : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)onSearchLaunch __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventOnSearchLaunch *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.ToggleFilter")))
@interface MiamCoreCatalogContractEventToggleFilter : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)toggleFilter __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventToggleFilter *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.ToggleSearch")))
@interface MiamCoreCatalogContractEventToggleSearch : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)toggleSearch __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventToggleSearch *shared __attribute__((swift_name("shared")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractState")))
@interface MiamCoreCatalogContractState : MiamCoreBase <MiamCoreUiState>
- (instancetype)initWithCategories:(MiamCoreBasicUiState<NSArray<MiamCorePackage *> *> *)categories content:(MiamCoreCatalogContent *)content catalogFilterVM:(MiamCoreCatalogFilterViewModel *)catalogFilterVM recipePageVM:(MiamCoreRecipeListPageViewModel *)recipePageVM filterOpen:(BOOL)filterOpen searchOpen:(BOOL)searchOpen __attribute__((swift_name("init(categories:content:catalogFilterVM:recipePageVM:filterOpen:searchOpen:)"))) __attribute__((objc_designated_initializer));
...
- (MiamCoreCatalogFilterViewModel *)component3 __attribute__((swift_name("component3()")));
- (MiamCoreRecipeListPageViewModel *)component4 __attribute__((swift_name("component4()")));
- (BOOL)component5 __attribute__((swift_name("component5()")));
- (BOOL)component6 __attribute__((swift_name("component6()")));
- (MiamCoreCatalogContractState *)doCopyCategories:(MiamCoreBasicUiState<NSArray<MiamCorePackage *> *> *)categories content:(MiamCoreCatalogContent *)content catalogFilterVM:(MiamCoreCatalogFilterViewModel *)catalogFilterVM recipePageVM:(MiamCoreRecipeListPageViewModel *)recipePageVM filterOpen:(BOOL)filterOpen searchOpen:(BOOL)searchOpen __attribute__((swift_name("doCopy(categories:content:catalogFilterVM:recipePageVM:filterOpen:searchOpen:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreCatalogFilterViewModel *catalogFilterVM __attribute__((swift_name("catalogFilterVM")));
...
@property (readonly) BOOL filterOpen __attribute__((swift_name("filterOpen")));
@property (readonly) MiamCoreRecipeListPageViewModel *recipePageVM __attribute__((swift_name("recipePageVM")));
@property (readonly) BOOL searchOpen __attribute__((swift_name("searchOpen")));
@end;
...
- (int32_t)getProviderId __attribute__((swift_name("getProviderId()")));
...
- (instancetype)initWithIsInError:(BOOL)isInError __attribute__((swift_name("init(isInError:)"))) __attribute__((objc_designated_initializer));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (MiamCoreContextHandlerState *)doCopyIsInError:(BOOL)isInError __attribute__((swift_name("doCopy(isInError:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface MiamCorePointOfSaleHandler : MiamCoreBase <MiamCoreKoin_coreKoinComponent>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
- (MiamCoreKoin_coreKoinApplication *)propertiesValues:(NSDictionary<NSString *, NSString *> *)values __attribute__((swift_name("properties(values:)")));
- (void)unloadModulesModules:(NSArray<MiamCoreKoin_coreModule *> *)modules __attribute__((swift_name("unloadModules(modules:)")));
...
@interface MiamCoreKoin_coreScope : MiamCoreBase
...
- (void)loadScopesModules:(NSArray<MiamCoreKoin_coreModule *> *)modules __attribute__((swift_name("loadScopes(modules:)")));
...
@interface MiamCoreKoin_coreInstanceFactory<T> : MiamCoreBase
...
@property (readonly) id<MiamCoreKoin_coreQualifier> _Nullable qualifier __attribute__((swift_name("qualifier")));
@property (readonly) id<MiamCoreKoin_coreQualifier> scopeQualifier __attribute__((swift_name("scopeQualifier")));
