...
- (void)updateGuestRecipeVm:(MiamCoreRecipeViewModel *)recipeVm guestCount:(int32_t)guestCount __attribute__((swift_name("updateGuest(recipeVm:guestCount:)")));
@property (readonly) NSString * _Nullable recipeId __attribute__((swift_name("recipeId")));
@end;
...
- (void)decreaseGuest __attribute__((swift_name("decreaseGuest()")));
...
- (void)increaseGuest __attribute__((swift_name("increaseGuest()")));
