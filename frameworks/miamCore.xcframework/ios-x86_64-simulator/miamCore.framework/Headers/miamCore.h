...
- (void)getPrice __attribute__((swift_name("getPrice()")));
...
- (instancetype)initWithCategoryId:(NSString *)categoryId title:(NSString *)title __attribute__((swift_name("init(categoryId:title:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (MiamCoreCatalogContractEventGoToRecipeListFromCategory *)doCopyCategoryId:(NSString *)categoryId title:(NSString *)title __attribute__((swift_name("doCopy(categoryId:title:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)emitEffectLe:(MiamCoreLikeEffect *)le __attribute__((swift_name("emitEffect(le:)")));
- (id<MiamCoreKotlinx_coroutines_coreFlow>)observeSideEffect __attribute__((swift_name("observeSideEffect()")));
@property (readonly) id<MiamCoreKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@end;
