...
@interface MiamCoreTagsRepositoryImp : MiamCoreBase
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)getTagsByTagTypeTagType:(NSString *)tagType completionHandler:(void (^)(NSArray<MiamCoreTag *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getTagsByTagType(tagType:completionHandler:)")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.TogglePreference")))
@interface MiamCoreCatalogContractEventTogglePreference : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)togglePreference __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventTogglePreference *shared __attribute__((swift_name("shared")));
@end;
...
- (instancetype)initWithCategories:(MiamCoreBasicUiState<NSArray<MiamCorePackage *> *> *)categories content:(MiamCoreCatalogContent *)content catalogFilterVM:(MiamCoreSingletonFilterViewModel *)catalogFilterVM recipePageVM:(MiamCoreRecipeListPageViewModel *)recipePageVM filterOpen:(BOOL)filterOpen searchOpen:(BOOL)searchOpen preferenceOpen:(BOOL)preferenceOpen enableFilters:(BOOL)enableFilters enablePreferences:(BOOL)enablePreferences __attribute__((swift_name("init(categories:content:catalogFilterVM:recipePageVM:filterOpen:searchOpen:preferenceOpen:enableFilters:enablePreferences:)"))) __attribute__((objc_designated_initializer));
...
- (MiamCoreSingletonFilterViewModel *)component3 __attribute__((swift_name("component3()")));
...
- (MiamCoreCatalogContractState *)doCopyCategories:(MiamCoreBasicUiState<NSArray<MiamCorePackage *> *> *)categories content:(MiamCoreCatalogContent *)content catalogFilterVM:(MiamCoreSingletonFilterViewModel *)catalogFilterVM recipePageVM:(MiamCoreRecipeListPageViewModel *)recipePageVM filterOpen:(BOOL)filterOpen searchOpen:(BOOL)searchOpen preferenceOpen:(BOOL)preferenceOpen enableFilters:(BOOL)enableFilters enablePreferences:(BOOL)enablePreferences __attribute__((swift_name("doCopy(categories:content:catalogFilterVM:recipePageVM:filterOpen:searchOpen:preferenceOpen:enableFilters:enablePreferences:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCoreSingletonFilterViewModel *catalogFilterVM __attribute__((swift_name("catalogFilterVM")));
...
@property (readonly) BOOL preferenceOpen __attribute__((swift_name("preferenceOpen")));
