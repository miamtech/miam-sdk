...
__attribute__((swift_name("PreferencesContext")))
@interface MiamCorePreferencesContext : MiamCoreBase
...
@interface MiamCoreMiamPreferencesContext : MiamCorePreferencesContext
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end;
...
+ (instancetype)new __attribute__((unavailable));
- (MiamCoreAnalyticEvent *)component1 __attribute__((swift_name("component1()")));
...
- (MiamCoreAnalyticsPlausibleProps *)component3 __attribute__((swift_name("component3()")));
...
- (void (^)(MiamCoreAnalyticEvent *))component1 __attribute__((swift_name("component1()")));
...
@interface MiamCoreAnalyticsInstance : MiamCoreBase <MiamCoreKoin_coreKoinComponent>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
- (MiamCoreBasicUiState<MiamCoreBasketPreviewLine *> *)component1 __attribute__((swift_name("component1()")));
- (NSArray<MiamCoreBasketPreviewLine *> *)component2 __attribute__((swift_name("component2()")));
...
- (MiamCoreBasicUiState<MiamCorePreferencesContent *> *)component1 __attribute__((swift_name("component1()")));
...
- (MiamCorePreferencesContext * _Nullable)getContextOrNull __attribute__((swift_name("getContextOrNull()")));
...
- (void)setContextContext:(MiamCorePreferencesContext *)context __attribute__((swift_name("setContext(context:)")));
@property (readonly) id<MiamCoreKotlinCoroutineContext> coroutineContext __attribute__((swift_name("coroutineContext")));
@property (readonly) id<MiamCoreKotlinx_coroutines_coreMutableStateFlow> state __attribute__((swift_name("state")));
@end;
...
- (instancetype)initWithIsInError:(BOOL)isInError applicationContext:(MiamCorePreferencesContext * _Nullable)applicationContext __attribute__((swift_name("init(isInError:applicationContext:)"))) __attribute__((objc_designated_initializer));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (MiamCorePreferencesContext * _Nullable)component2 __attribute__((swift_name("component2()")));
- (MiamCoreContextHandlerState *)doCopyIsInError:(BOOL)isInError applicationContext:(MiamCorePreferencesContext * _Nullable)applicationContext __attribute__((swift_name("doCopy(isInError:applicationContext:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) MiamCorePreferencesContext * _Nullable applicationContext __attribute__((swift_name("applicationContext")));
...
@interface MiamCorePreferencesContext (Extensions)
