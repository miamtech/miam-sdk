...
- (MiamCoreRoute * _Nullable)popRoute __attribute__((swift_name("popRoute()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CatalogContractEvent.OnCloseModal")))
@interface MiamCoreCatalogContractEventOnCloseModal : MiamCoreCatalogContractEvent
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
+ (instancetype)onCloseModal __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MiamCoreCatalogContractEventOnCloseModal *shared __attribute__((swift_name("shared")));
@end;
